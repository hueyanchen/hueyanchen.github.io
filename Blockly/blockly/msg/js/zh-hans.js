...
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "创建列表使用";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "将一个项添加到列表中。";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "创建一个具有任意数量项目的列表。";
...
Blockly.Msg.LISTS_REPEAT_TITLE = "创建列表使用项 %1 重复 %2 次";
Blockly.Msg.LISTS_REPEAT_TOOLTIP = "创建包含指定重复次数的值的列表。";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "取得一段文本自第一个字符";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "取得一段文本自倒数第#个字符";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "取得一段文本自#";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "返回在第二个文本中的第一/最后一个匹配项的索引值。如果未找到则返回%1。";
...
Blockly.Msg.TEXT_JOIN_TITLE_CREATEWITH = "创建文本使用";
...
Blockly.Msg.TEXT_PROMPT_TYPE_INTEGER = "输入 整数 并显示提示消息";
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER = "输入 数字 并显示提示消息";
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = "输入 文本 并显示提示消息";
...
Blockly.Msg.CONTROLS_FOR_INPUT_ORDER = "递增计数迴圈";
