...
Blockly.Msg.ARD_VAR_AS_TIP = "Case operator, sets a value to a specific type";
...
// Enhanced Msgs
Blockly.Msg.ARD_SETTONEDURE="tone pin#";
Blockly.Msg.ARD_TONEDURE="duration";
Blockly.Msg.ARD_MAP2_VAL="value";
Blockly.Msg.ARD_MAP2_FromLow="fromLow";
Blockly.Msg.ARD_MAP2_FromHigh="fromHigh";
Blockly.Msg.ARD_MAP2_ToLow="toLow";
Blockly.Msg.ARD_MAP2_ToHigh="toHigh";
Blockly.Msg.ARD_MAP2_TIP="Re-maps a number from [?-?] to [?-?].";

Blockly.Msg.ARD_CAR_L298N="L298N module: ";
Blockly.Msg.ARD_CAR_L298N_TIP="Define L298N Module Pins"
Blockly.Msg.ARD_CAR_Move="move car";
Blockly.Msg.ARD_CAR_Move_TIP="Move Car Function";
Blockly.Msg.ARD_CAR_MOVE_WARN="A setup block for %1 must be added to the workspace to use this block!";
Blockly.Msg.ARD_CAR_ULTRASOUND="HC-SR04 module: ";
Blockly.Msg.ARD_CAR_ULTRASOUND_TIP="Define HC-SR04 Echo/Trigger Pins";
Blockly.Msg.ARD_CAR_ULTRASOUND_DISTANCE="ultrasound sensor value";
Blockly.Msg.ARD_CAR_ULTRASOUND_DISTANCE_TIP="Returns Ultrasound Sensor value";
Blockly.Msg.ARD_CAR_ULTRASOUND_Echo="echo pin#";
Blockly.Msg.ARD_CAR_ULTRASOUND_Trigger="trigger pin#"
Blockly.Msg.ARD_CAR_ULTRASOUND_DISTANCE_WARN="A setup block for %1 must be added to the workspace to use this block!";
Blockly.Msg.ARD_CAR_MOVE_WARNING="PWM must be in range 0 - 255";

Blockly.Msg.ARD_SERIAL_AVAILABLE="available";
Blockly.Msg.ARD_SERIAL_AVAILABLE_TIP="Serial Available";
Blockly.Msg.ARD_SERIAL_READ="read byte";
Blockly.Msg.ARD_SERIAL_READSTRING="readString";
Blockly.Msg.ARD_SERIAL_READ_TIP="Serial Read Function";
Blockly.Msg.ARD_SERIAL_PARSEINT="read int";
Blockly.Msg.ARD_SERIAL_PARSEFLOAT="parseFloat";
Blockly.Msg.ARD_SERIAL_PARSE_TIP="Serial Parse Function";

Blockly.Msg.ARD_DIGITALPIN_TIP="Arduino digital Pins List";
Blockly.Msg.ARD_ANALOGPIN_TIP="Arduino analog Pins List";
Blockly.Msg.ARD_PWMPIN_TIP="Arduino PWM Pins List";

Blockly.Msg.ARD_SOFTSERIAL_SETUP="SoftwareSerial Setup";
Blockly.Msg.ARD_SOFTSERIAL_SETUP_TIP="SoftwareSerial Definition";
Blockly.Msg.ARD_SOFTSERIAL_AVAILABLE="available";
Blockly.Msg.ARD_SOFTSERIAL_AVAILABLE_TIP="SoftwareSerial Available";
Blockly.Msg.ARD_SOFTSERIAL_PRINT="SofwareSerial print";
Blockly.Msg.ARD_SOFTSERIAL_PRINT_TIP="Software Serial Print Function";
Blockly.Msg.ARD_SOFTSERIAL_READ="read byte";
Blockly.Msg.ARD_SOFTSERIAL_READSTRING="readString";
Blockly.Msg.ARD_SOFTSERIAL_READ_TIP="Software Serial Read Function";

Blockly.Msg.VARIABLES_CONST="const type %1 declare %2 to %3";
Blockly.Msg.VARIABLES_CONST_HELPURL="https://github.com/google/blockly/wiki/Variables#declare";  // untranslated
Blockly.Msg.VARIABLES_CONST_TOOLTIP="Declare const variable and set to the input";

Blockly.Msg.VARIABLES_INITIAL="declare %1 variable %2 to %3";
Blockly.Msg.VARIABLES_INITIAL_HELPURL="https://github.com/google/blockly/wiki/Variables#declare";  // untranslated
Blockly.Msg.VARIABLES_INITIAL_TOOLTIP="Declare variable and set to the input";

Blockly.Msg.MATH_INC_DECREMENT_EXP_TIP="Increment/Decrement Expression";
Blockly.Msg.ARD_VAR_AUTO_TYPE_TIP="Assignment and Arithmetic Type Conversions";

Blockly.Msg.TEXT_CHAR='http://arduino.cc/en/Reference/char';
Blockly.Msg.TEXT_CHAR_TOOLTIP='A data type that takes up 1 byte of memory that stores a character value. Character literals are written in single quotes.';
Blockly.Msg.TEXT_CHAR_WARNING="stores only a character value";

Blockly.Msg.VARIABLES_CONST_WARNING="variable is constant, canot change value!";

Blockly.Msg.TEXT_TOINT_HELPURL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/toint/";
Blockly.Msg.TEXT_TOINT_TITLE = "convert %1 to integer";
Blockly.Msg.TEXT_TOINT_TOOLTIP = "Converts to an integer of provided text.";
...
Blockly.Msg.TEXT_TOFLOAT_TITLE = "convert %1 to float";
Blockly.Msg.TEXT_TOFLOAT_TOOLTIP = "Converts to a float of provided text.";