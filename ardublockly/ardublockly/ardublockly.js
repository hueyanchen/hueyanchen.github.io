...
Ardublockly.init = function() {
  ...
  Ardublockly.createMainBlock();      //  建立預設的setup()和loop()程序
...
// 建立預設的setup()和loop()程序
Ardublockly.createMainBlock = function() {
  var xmlString =  '<xml xmlns="http://www.w3.org/1999/xhtml">' +
  '<block type="arduino_functions" x="53" y="42"></block></xml>';
  Ardublockly.replaceBlocksfromXml(xmlString);
...
Ardublockly.bindActionFunctions = function() {
  ...
  Ardublockly.bindClick_('button_download', Ardublockly.saveSketchFile);
